...
#[allow(unused)]
fn main() {
    let _r1: [f64; 3] = [5000., 10000., 2100.]; // [km]
    let _r2: [f64; 3] = [-14600., 2500., 7000.]; // [km]
    let dt: f64 = 1.0 * 3600.; // [s]
    let r1 = Vector3::from(_r1);
    let r2 = Vector3::from(_r2);

    let (v1, v2) = lambert(_r1, _r2, Direction::Prograde, dt);
...
fn lambert(
    ...
    //println!("dtheta = {:.4} deg", dtheta.to_degrees());
